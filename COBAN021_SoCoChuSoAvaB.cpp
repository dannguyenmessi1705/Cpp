...
ull Recursive (ull result, short x, int xcount, short y, int ycount, ull n, int sochuso){
    ...
    return min(Recursive(result * 10 + x, x, xcount + 1, y, ycount, n, sochuso), Recursive(result * 10 + y, x, xcount, y, ycount + 1, n ,sochuso));
}

ull FindNum(ull n, short x, short y){
